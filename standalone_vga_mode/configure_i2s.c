...
volatile uint8_t *  m_DMAData;
   ...
   *     GPIOStream.stop();
   */
  void begin_i2s(bool div1_onGPIO0, gpio_num_t div2 = GPIO_UNUSED, gpio_num_t div4 = GPIO_UNUSED, gpio_num_t div8 = GPIO_UNUSED, gpio_num_t div16 = GPIO_UNUSED, gpio_num_t div32 = GPIO_UNUSED, gpio_num_t div64 = GPIO_UNUSED, gpio_num_t div128 = GPIO_UNUSED, gpio_num_t div256 = GPIO_UNUSED);
   ...
   *     GPIOStream.play(25000000);
   */
void play_i2s(int freq, lldesc_t volatile * dmaBuffers = nullptr);
...
void begin_i2s(bool div1_onGPIO0, gpio_num_t div2, gpio_num_t div4, gpio_num_t div8, gpio_num_t div16, gpio_num_t div32, gpio_num_t div64, gpio_num_t div128, gpio_num_t div256)
{
  m_DMAStarted = false;
